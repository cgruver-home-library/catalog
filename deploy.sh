...
APP_NAME=catalog
GIT_REPOSITORY=https://github.com/lab-monkeys/catalog.git
CONFIG_GIT_REPOSITORY=https://github.com/lab-monkeys/catalog.git
CONFIG_GIT_BRANCH=main
CONFIG_GIT_PATH=/catalog/okd-config/dev
